...
func (_m *SecurityService) GenToken(userID string, tokenType string, exp int64) (string, error) {
...
func (_m *SecurityService) GetAndValidateAccessToken(ctx echo.Context) (auth.TokenMetadata, error) {
	ret := _m.Called(ctx)
...
func (_m *SecurityService) GetAndValidateRefreshToken(ctx echo.Context) (auth.TokenMetadata, error) {
	ret := _m.Called(ctx)
...
func (_m *SecurityService) Hash(password string) ([]byte, error) {
...
func (_m *SecurityService) VerifyPassword(hashedPassword string, password string) error {
